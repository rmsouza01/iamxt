...
def ws_markers_c(ii32, DIM1, DIM1, DIM1, DIM1, DIM1, DIM1, DIM1):
    """ws_markers_c(int ii32, int DIM1, int DIM1, int DIM1, int DIM1, int DIM1, int DIM1, int DIM1)"""
    return _watershed_c.ws_markers_c(ii32, DIM1, DIM1, DIM1, DIM1, DIM1, DIM1, DIM1)

def tz_ws_c(ii32, DIM1, DIM1, DIM1, DIM1, DIM1, DIM1, DIM1):
    """tz_ws_c(int ii32, int DIM1, int DIM1, int DIM1, int DIM1, int DIM1, int DIM1, int DIM1)"""
    return _watershed_c.tz_ws_c(ii32, DIM1, DIM1, DIM1, DIM1, DIM1, DIM1, DIM1)

def window_histogram_aux_c(DIM1, DIM1, DIM1, DIM1):
    """window_histogram_aux_c(int DIM1, int DIM1, int DIM1, int DIM1)"""
    return _watershed_c.window_histogram_aux_c(DIM1, DIM1, DIM1, DIM1)
